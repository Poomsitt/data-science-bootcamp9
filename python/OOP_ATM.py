...
class ATM:
    def __init__(self, account_name, bank_name, initial):
        ...
        self.balance = initial ## ไม่จำเป็นต้องชื่อเดียวกัน

    def __str__(self):
        return f"This is an account of {self.account_name}, bank: {self.bank_name}"

    ## method -> function for this object only
    ...
    def get_otp(self):
        ...
        print(f"Your OTP: {otp} This OTP will be available in the nesxt 2 minutes.")
